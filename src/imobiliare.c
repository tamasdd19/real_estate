...
{
    Lista_imobile* nou=(Lista_imobile*)malloc(sizeof(Lista_imobile));
    if(n!=0)
    {
        nou->Imobil=(imobil*)malloc(sizeof(imobil)*(n+10));
        nou->capacitate=n+10;
        nou->nr_imobile=n;
    }
    else
    {
        nou->Imobil=(imobil*)malloc(sizeof(imobil)*2);
        nou->capacitate=2;
        nou->nr_imobile=0;
    }
    return nou;
...
{
    Lista_imobile_favorite* nou=(Lista_imobile_favorite*)malloc(sizeof(Lista_imobile_favorite));
...
void initializare_imobile(Lista_imobile* lista_imobile, Lista_imobile_favorite* lista_favorite)
{
    ...
    *lista_imobile=*initializare_lista(n);
    ...
    for(int i=0; i<n; i++)
    {
        ...
        fscanf(f,"%d",&nou->pret);
        fscanf(f,"%hd",&nou->tip);
        fscanf(f,"%hd",&nou->suprafata);
        fscanf(f,"%hd",&nou->confort);
        fscanf(f,"%hd",&nou->anul_constructiei);
        fscanf(f,"%hd",&nou->numar_camere);
        fscanf(f,"%hd",&nou->numar_bai);
        fscanf(f,"%hd",&nou->etaj);
        fscanf(f,"%hd",&nou->numar_balcoane);
        fscanf(f,"%hd",&nou->piscina);
        fscanf(f,"%hd\n",&nou->terasa);
...
short meniu_cumparare(Lista_imobile* lista_imobile, Lista_imobile_favorite* lista_favorite)
{
    ...
    while(optiune!=lista_imobile->nr_imobile && optiune!=lista_imobile->nr_imobile+1)
    {
        ...
        else if(optiune_imobil==1)
        {
            /*
            system("cls");
            printf("%s",lista_favorite->lista[0].titlu);
            system("pause");*/
            adaugare_favorite(lista_favorite,lista_imobile,optiune);
            goto back;
        }
...
short meniu_favorite(Lista_imobile* lista, Lista_imobile_favorite* lista_favorite)
{
    ...
    {
        optiuni[i]=lista->Imobil[lista_favorite->pozitii[i]].titlu;
    }
    ...
    {
        optiune_imobil=afisare_imobil(&lista->Imobil[lista_favorite->pozitii[optiune]], 0);
        if(optiune_imobil==1)
            optiune=meniu(optiuni,0,lista_favorite->nr_favorite+2,'\0');
        else if(optiune_imobil==0)
        {
...
void meniu_vanzare(Lista_imobile* lista_imobile, Lista_imobile_favorite* lista_favorite)
{
    ...
    scanf("%hd",&nou_imobil->tip);
    printf("Suprafata: ");
    scanf("%hd",&nou_imobil->suprafata);
    printf("Confort: ");
    scanf("%hd",&nou_imobil->confort);
    printf("Anul constructiei: ");
    scanf("%hd",&nou_imobil->anul_constructiei);
    printf("Numar camere: ");
    scanf("%hd",&nou_imobil->numar_camere);
    printf("Numar bai: ");
    scanf("%hd",&nou_imobil->numar_bai);
    printf("Etaj/e: ");
    scanf("%hd",&nou_imobil->etaj);
    printf("Numar balcoane: ");
    scanf("%hd",&nou_imobil->numar_balcoane);
    printf("Piscina(1:da,0:nu): ");
    scanf("%hd",&nou_imobil->piscina);
    printf("Terasa(1:da,0:nu): ");
    scanf("%hd",&nou_imobil->terasa);
    system("cls");
